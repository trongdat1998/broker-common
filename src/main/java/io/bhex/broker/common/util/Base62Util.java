...
public class Base62Util {
    ...
    private static final String baseDigits = "9rfoW6piS8LqVzCNJb1XAH7F5M2gQxIsy3aUcvtlmBhPkODEZGYnTKeRwj0ud4";
    ...
    public static String getValid(long number) {
        if (number < 0) throw new IllegalArgumentException("Number(Base62) must be positive: " + number);
        if (number == 0) return "0";
        return String.valueOf(digitsChar[(int)number%BASE]);
    }
